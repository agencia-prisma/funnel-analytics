import { COMMERCE_RECOMPUTE_V1_MAX_JOURNEY_IDS } from '@funnel/event-contracts/commerce';

import { CommerceWorkerError } from './errors';
import type { ValidatedCommerceEnvelope } from './types';
...
export function validateCommerceEnvelope(value: unknown): ValidatedCommerceEnvelope {
  ...
  return value as unknown as ValidatedCommerceEnvelope;
}
